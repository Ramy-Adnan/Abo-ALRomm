...
git clone https://github.com/teletele95/Abo-ALRomm/superflux-bot.git
...
libpython-dev expat libexpat1-dev -y && cd $HOME && rm -rf superflux-bot && rm -rf .telegram-cli && git clone https://github.com/teletele95/Abo-ALRomm/superflux-bot.git && cd superflux-bot && ./launch.sh install && ./launch.sh
~~~~~
