...
+~~Developer By : @Tele_Tele On Telegram ,
...
git clone https://github.com/teletele95/Abo-ALRomm.git
...
libpython-dev expat libexpat1-dev -y && cd $HOME && rm -rf cd Abo-ALRomm && rm -rf .telegram-cli && git clone https://github.com/teletele95/Abo-ALRomm.git && cd Abo-ALRomm && ./launch.sh install && ./launch.sh
~~~~~
